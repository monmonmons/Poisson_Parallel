...
void P_BICGSTAB(Stencil *A, double *diag, double *rhs, double *x, 
    ...
    for (nits = 1; nits <= maxit; nits++) {
	    ...
	    switch (precond) {
	        ...
	        case 2: Precond_GS(A, diag, d, y, EPSILON, nlx, nly, precond_iter);  break;
            case 3: Precond_CG(A, diag, d, y, EPSILON, nlx, nly, precond_iter);  break;
	    }
        // update inner boundary values
	    ...
	    switch (precond) {
	        ...
	        case 2: Precond_GS(A, diag, s, z, EPSILON, nlx, nly, precond_iter);  break;
            case 3: Precond_CG(A, diag, s, z, EPSILON, nlx, nly, precond_iter);  break;
	    }
